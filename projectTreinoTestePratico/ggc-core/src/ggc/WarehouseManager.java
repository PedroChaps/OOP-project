...
public class WarehouseManager {
  ...
  public List<?> showBatchesByPartner(String partnerID) throws
                                        UndefinedPartnerKeyException {
    return _warehouse.processShowBatchesByPartner(partnerID);
  }

  public List<?> showBatchesByProduct(String productID) throws
  ...
  public void receivePayment(int transactionID) throws
                                    UndefinedTransactionKeyException {
    _warehouse.processReceivePayment(transactionID);
  }

  public String showTransaction(int transactionID) throws
                                    UndefinedTransactionKeyException {
    return _warehouse.processShowTransaction(transactionID);
  }

  public List<?> lookupPaymentsByPartner(String partnerID) throws
                                        UndefinedPartnerKeyException {
    return _warehouse.processLookupPaymentsByPartner(partnerID);
  }

  public void registerBreakdownTransaction(String partnerID,
                                       String productID, int amount)
                                  throws UndefinedProductKeyException,
                                         UndefinedPartnerKeyException,
                                                 LowOnStockException {
    _warehouse.processRegisterBreakdownTransaction(partnerID,
                                                   productID, amount);
  }

  public void registerAcquisitionTransfer(String partnerID,
                         String productID, double price, int amount)
                                 throws UndefinedPartnerKeyException {
    _warehouse.processRegisterAcquisition(partnerID, productID,
                                                       price, amount);
  }
  public void registerAcquisitionTransferNewProduct(String partnerID,
                          String productID, double price, int amount)
                                 throws UndefinedPartnerKeyException {
    _warehouse.processRegisterAcquisitionNewProduct(partnerID,
  ...
  public void registerSimpleProduct(String productID, int stock,
                                                       double price) {
    _warehouse.registerSProduct(productID,stock,price);
  }
  public void registerDerivedProduct(String productID, int stock,
                          double price, double alpha, String recipe) {
    _warehouse.registerDerivedProduct(productID, stock, price,
                                                       alpha, recipe);
  }
  public void registerSaleTransaction(String partnerID,
                  int paymentDeadline, String productID, int amount)
                                           throws LowOnStockException,
                                         UndefinedPartnerKeyException,
                                        UndefinedProductKeyException {
    _warehouse.processRegisterSaleTransaction(partnerID,
                                  paymentDeadline, productID, amount);
  }

  public void toggleProductNotifications(String partnerID,
                                                     String productID)
                                  throws UndefinedProductKeyException,
                                        UndefinedPartnerKeyException {
  ...
  public List<?> showPartnerSales(String partnerID)
                                 throws UndefinedPartnerKeyException {
    return _warehouse.processShowBreakdownsAndSalesByPartner(partnerID);
  }

  public List<?> showPartnerAcquisitions(String partnerID)
                                 throws UndefinedPartnerKeyException {
    return _warehouse.processShowAcquisitionsByPartner(partnerID);
  }
  
  public void changePartnerName(String partnerID, String newName) throws UndefinedPartnerKeyException{
    return _warehouse.processChangePartnerName(partnerID, newName);
  }
