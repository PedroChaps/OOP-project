...
public class Sale extends Transaction{
    ...
    public Sale (int id, int amount, double finalPrice,
               Partner partner, Product product, int paymentDeadline){
    ...
    public double calculatePrice(int currentDate){
        ...
        double calculatedPrice = getFinalPrice() *
                p.getDiscountOrFine(_paymentDeadline,
                                        currentDate, pr.getOffsetN());
    ...
    public String displayTransaction(int date){
        String s =  super.toString() + "|" +
                ...
                Math.round(getCurrentPayingPrice(date)) + "|" +
                _paymentDeadline;
