  ...
  public final void execute() throws CommandException {
    try {
      ...
      if (_receiver.productExists(productID))
        _receiver.registerAcquisitionTransfer(partnerID, productID,
                                                       price, amount);
      else {
        Form form = new Form();
        if (!form.confirm(Prompt.addRecipe()))
          ...
          _receiver.registerDerivedProduct(productID, amount, price,
                                                       alpha, recipe);
        }
        _receiver.registerAcquisitionTransferNewProduct(partnerID,
