...
public class Batch implements Serializable, Comparable<Batch> {
    ...
    private final double _price; //P preço por unidade

    public Batch(Partner partner, Product product, int id, int amount,
                 double price) {
        _partner = partner;
        _product = product;
        _id = id;
    ...
    public double getTotalPrice(){return _price * _currentAmount;}
