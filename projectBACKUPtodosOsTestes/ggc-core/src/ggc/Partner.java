...
// TODO Observer podia ser uma classe abstrata com uma variável que diz o meio de notificação atual
...
public class Partner implements Serializable, Comparable<Partner>,Observer{
    ...
    public double getValueBought(){ return _totalValueBought;}
    public double getValueSold(){ return _totalValueSold;}
    public double getValuePaid(){return _totalValuePaid;}
    public void addValueBought(double value){_totalValueBought += value;}
    public void addValueSold(double value){_totalValueSold += value;}
    public void addValuePaid(double value){_totalValuePaid += value;}
    ...
    //public void pay(){...if (!atrasado) _status.buy(valor da compra);
    //                      else _status.delayedSell(tempo atrasado)
    //                      ...
    //                      getDiscountorFine()
    //                      .....
//     }
    ...
    public String toString(){
        return _id + "|" + _name + "|" + _address + "|" +
                getStatusName() + "|" + Math.round(getStatusPoints()) + "|" +
